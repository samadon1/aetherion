...
// Gap Finder Tab - Analyzes data gaps using NVIDIA Cosmos Reason 2
...
export function GapFinderTab({
  ...
  const analyzeGaps = useCallback(async () => {
    ...
    const prompt = `You are an autonomous vehicle data analyst using physical AI reasoning. Identify missing driving scenarios in this dataset based on real-world coverage requirements.
...
Respond in JSON:
{
  ...
  }, [cosmosReasonEndpoint, topicInfo, userScenario, onGapsUpdate]);
